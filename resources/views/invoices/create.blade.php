        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><strong>Add</strong> New Invoice</h5>
                        ...
                        <form method="post" enctype="multipart/form-data" action="#" id="invoiceform">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" id="date" name="date" class="form-control" value="{{old('date')}}" placeholder="Enter New Date">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Amount</label>
                                <div class="col-sm-10">
                                    <input type="text" id="title" name="amount" class="form-control" value="{{old('amount')}}" placeholder="Enter Amount">
                                </div>
                            </div>
                            ...
                            <fieldset class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="gridRadios1" value="unpaid" checked>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="gridRadios2" value="paid">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="gridRadios3" value="cancelled">
                                        <label class="form-check-label" for="gridRadios2">
                                            Cancelled
                                        </label>
                                    </div>
    ...
    $('#submit').click(function(e) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#invoiceform")[0].reset()
                $("#frmerrormsg").addClass('alert alert-success').text('Invoice Added Successfully');
