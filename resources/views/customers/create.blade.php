        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><strong>Add</strong> New Customer</h5>
                        ...
                        <form method="post" enctype="multipart/form-data" action="#" id="customerForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="name" name="name" class="form-control" value="{{old('name')}}" placeholder="Enter New Customer">
                                </div>
                            </div>
                            <div class="row mb-3">
    ...
    $('#submit').click(function(e) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#frmerrormsg").addClass('alert alert-success').text('Customer Added Successfully');
